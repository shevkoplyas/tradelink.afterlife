...
namespace TradeLink.AppKit
{
    ...
    public partial class AppTracker : System.Windows.Forms.Form
    {
        ...
        //string _URL = @"http://tradelinkappstore.appspot.com/apptracker"; // <- dimon: original value
        string _URL = @"http://127.0.0.1/non/existing/app.php";             // <- dimon: replaced to non-existing
        // 
