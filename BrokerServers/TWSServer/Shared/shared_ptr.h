...
public:
   ...
   template<typename Y> friend class ::shared_ptr;	// dimon: for some reason without "::" it was ambiguous (with std::shared_ptr) even though there's no "using namespace std" anywhere in TWSServer.. hmm...  :-\
